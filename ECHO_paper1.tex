...
%Measurement using a nearby emission source must take into account near-field effects. 
...
%In this section, we compare the measurements of antennas A and B acquired by ECHO with similar measurements acquired by the Orbcomm-based system of [[[TBD: cite Neben]]].  Our goal is establish a baseline estimate of the systematic error in the ECHO system.

% and to provide a data product we could compare to the Orbcomm characterization of the AUTs, 
...
%The E-plane, which passes through the nulls of both the AUTs and the transmitter beams, contains the most uncertain portion of the beam measurements. In the nulls, the sensitivity is lowest and both AUT and transmitter beams are steep functions of zenith angle. 
